...
export default function Toolbar() {
  const { elements, groups, canvasWidth, canvasHeight, setCanvasSize, animDuration, animLoop, setAnimDuration, setAnimLoop, animStopPoints, setAnimStopPoints, activeTemplate } = useCanvasStore()
  ...
  const resetCanvas = () => {
    ...
    useCanvasStore.setState({
      ...
      animDuration: 5, animLoop: 1, animStopPoints: [],
      activeTemplate: null,
    })
  ...
  const handleSave = () => {
    setMenuOpen(false)
    saveBannerJSON({ elements, groups, canvasWidth, canvasHeight, bannerName, animDuration, animLoop, animStopPoints, activeTemplate })
  }
  ...
  const handleLoadFile = (e) => {
    ...
    loadBannerJSON(file, (err, data) => {
      ...
      setAnimStopPoints(data.animStopPoints ?? [])
