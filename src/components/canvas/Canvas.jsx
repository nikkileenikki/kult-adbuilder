...
export default function Canvas() {
  const { elements, groups, canvasWidth, canvasHeight, setSelected, snapLines, activeTemplate, animStopPoints, animDuration } = useCanvasStore()
  ...
  useEffect(() => {
    ...
    let cancelled = false
    buildPreviewHtml({ elements, groups, canvasWidth, canvasHeight, activeTemplate, animStopPoints, animDuration })
      .then((html) => { if (!cancelled) setPreviewHtml(html) })
      .catch(() => {})
    return () => { cancelled = true }
  }, [isAdvanced, elements, groups, canvasWidth, canvasHeight, activeTemplate, animStopPoints, animDuration])
